...
interface AddTransplantModalProps {
  visible: boolean;
  onClose: () => void;
  onSuccess: () => void;
  editItem?: any;
...
export default function AddTransplantModal({ visible, onClose, onSuccess, editItem }: AddTransplantModalProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Success', `Transplant ${editItem ? 'updated' : 'added'} successfully`);
      onSuccess();
      onClose();
    } catch (error: any) {
      console.error('Error saving transplant:', error);
      Alert.alert('Error', error.message || 'Failed to save transplant');
    } finally {
      setLoading(false);
    }
  };
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>{editItem ? 'Edit' : 'Add'} Transplant</Text>
          ...
          <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
            ...
            >
              {loading ? (
                ...
                <Text style={styles.saveButtonText}>{editItem ? 'Update' : 'Add'} Transplant</Text>
              )}
            </TouchableOpacity>
          </ScrollView>
        </View>
