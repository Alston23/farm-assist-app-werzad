    ...
    <View style={styles.container}>
      ...
      <LinearGradient colors={['#2D5016', '#4A7C2C', '#6BA542']} style={styles.gradient}>
        ...
        >
          ...
          >
            <Text style={styles.addButtonText}>+ Add Fertilizer</Text>
          </TouchableOpacity>

          {fertilizers.length === 0 ? (
            <View style={styles.emptyCard}>
              <Text style={styles.emptyText}>No fertilizers added yet</Text>
              <Text style={styles.emptySubtext}>Tap the button above to add your first fertilizer</Text>
            </View>
          ) : (
            <React.Fragment>
                ...
                <View key={index} style={styles.card}>
                  <View style={styles.cardHeader}>
                    ...
                    <View style={styles.cardActions}>
                      <TouchableOpacity
                        onPress={() => handleEdit(fertilizer)}
                        style={styles.actionButton}
                      >
                        <Text style={styles.actionButtonText}>Edit</Text>
                      </TouchableOpacity>
                      <TouchableOpacity
                        onPress={() => handleDelete(fertilizer.id)}
