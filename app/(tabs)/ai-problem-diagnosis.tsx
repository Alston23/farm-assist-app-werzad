...
export default function AIProblemDiagnosisScreen() {
  ...
  React.useEffect(() => {
    const initialPrompt = 'I need help diagnosing a problem with my crops. Can you help me identify what might be wrong?';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>🔍 Problem Diagnosis</Text>
